...
public class AddTierDescriptionAssignmentPage extends BasePage
{
	...
	public boolean enterDrugList(String strDrugList) throws Throwable
	{
		...
		{
			return rxNovaCommonUtil.setTextOnEdit(AssignmentCriteria_Add_TierDescription_DrugList_Edit, strDrugList);
		}
		else
		{
			return true;
	...
	public boolean updateTierDescriptionAssignment(String strTierDescriptionAssignment) throws Throwable
	{
		...
		{
			return rebateCommonUtil.rebate_Webtable_ClickOnCheckBox(AssignmentCriteria_Add_TierDescriptionAssignment_Table, strTierDescriptionAssignment);
		}
		else
		{
			return true;
	...
	{
		return rxNovaCommonUtil.clickOnButton(AssignmentCriteria_Add_TierDescription_Remove_Button);
	}
	
	public boolean clickOnUpdateButton() throws Throwable
	{
		return rxNovaCommonUtil.clickOnButton(AssignmentCriteria_Add_TierDescription_Update_Button);
	}
	
	public boolean verifyTierDescriptionAssignmentDetails(String strTierDescriptionAssignmentDetails) throws Throwable
	{
		return rebateCommonUtil.rebate_Webtable_VerifyRowData(AssignmentCriteria_Add_TierDescriptionAssignment_Table, strTierDescriptionAssignmentDetails);
	}
}
