...
public class AddFocusedUMBundleRespiratoryAssignmentPage extends BasePage
{
	...
	public boolean enterCoverageCode1(String strCoverageCode1) throws Throwable
	{
		...
		{
			return rxNovaCommonUtil.setTextOnEdit(AssignmentCriteria_Add_FocusedUMBundleRespiratory_CoverageCode1_Edit, strCoverageCode1);
		}
		else
		{
			return true;
	...
	public boolean enterCoverageCode2(String strCoverageCode2) throws Throwable
	{
		...
		{
			return rxNovaCommonUtil.setTextOnEdit(AssignmentCriteria_Add_FocusedUMBundleRespiratory_CoverageCode2_Edit, strCoverageCode2);
		}
		else
		{
			return true;
	...
	public boolean enterCoverageCodeDescription(String strCoverageCodeDescription) throws Throwable
	{
		...
		{
			return rxNovaCommonUtil.setTextOnEdit(AssignmentCriteria_Add_FocusedUMBundleRespiratory_Description_Edit, strCoverageCodeDescription);
		}
		else
		{
			return true;
	...
	public boolean enterCoverageCodeStatus(String strCoverageCodeStatus) throws Throwable
	{
		...
		{
			return rxNovaCommonUtil.setTextOnEdit(AssignmentCriteria_Add_FocusedUMBundleRespiratory_CoverageCodeStatus_Edit, strCoverageCodeStatus);
		}
		else
		{
			return true;
	...
	public boolean selectAvailableCoverageCodes(String strAvailableCoverageCodes) throws Throwable
	{
		...
		{
			return rebateCommonUtil.rebate_Webtable_ClickOnCheckBox(AssignmentCriteria_Add_FocusedUMBundleRespiratory_AvailableCoverageCode_Table, strAvailableCoverageCodes);
		}
		else
		{
			return true;
	...
	public boolean enterDrugListID(String strDrugListID) throws Throwable
	{
		...
		{
			return rxNovaCommonUtil.setTextOnEdit(AssignmentCriteria_Add_FocusedUMBundleRespiratory_DrugListID_Edit, strDrugListID);
		}
		else
		{
			return true;
	...
	public boolean enterDrugListName(String strDrugListName) throws Throwable
	{
		...
		{
			return rxNovaCommonUtil.setTextOnEdit(AssignmentCriteria_Add_FocusedUMBundleRespiratory_Name_Edit, strDrugListName);
		}
		else
		{
			return true;
	...
	public boolean enterDrugListType(String strDrugListType) throws Throwable
	{
		...
		{
			return rxNovaCommonUtil.setTextOnEdit(AssignmentCriteria_Add_FocusedUMBundleRespiratory_Type_Edit, strDrugListType);
		}
		else
		{
			return true;
	...
	public boolean enterDrugListStatus(String strDrugListStatus) throws Throwable
	{
		...
		{
			return rxNovaCommonUtil.setTextOnEdit(AssignmentCriteria_Add_FocusedUMBundleRespiratory_DrugListStatus_Edit, strDrugListStatus);
		}
		else
		{
			return true;
	...
	public boolean selectAvailableDrugLists(String strAvailableDrugLists) throws Throwable
	{
		...
		{
			return rebateCommonUtil.rebate_Webtable_ClickOnCheckBox(AssignmentCriteria_Add_FocusedUMBundleRespiratory_AvailableDrugList_Table, strAvailableDrugLists);
		}
		else
		{
			return true;
	...
	public boolean enterClientNumber(String strClientNumber) throws Throwable
	{
		...
		{
			return rxNovaCommonUtil.setTextOnEdit(AssignmentCriteria_Add_FocusedUMBundleRespiratory_ClientNumber_Edit, strClientNumber);
		}
		else
		{
			return true;
	...
	public boolean enterClientName(String strClientName) throws Throwable
	{
		...
		{
			return rxNovaCommonUtil.setTextOnEdit(AssignmentCriteria_Add_FocusedUMBundleRespiratory_ClientName_Edit, strClientName);
		}
		else
		{
			return true;
	...
	public boolean enterClientStartDate(String strClientStartDate) throws Throwable
	{
		...
		{
			return rxNovaCommonUtil.setTextOnEdit(AssignmentCriteria_Add_FocusedUMBundleRespiratory_ClientStartDate_Edit, strClientStartDate);
		}
		else
		{
			return true;
	...
	public boolean enterClientEndDate(String strClientEndDate) throws Throwable
	{
		...
		{
			return rxNovaCommonUtil.setTextOnEdit(AssignmentCriteria_Add_FocusedUMBundleRespiratory_ClientEndDate_Edit, strClientEndDate);
		}
		else
		{
			return true;
	...
	public boolean selectAvailableClients(String strAvailableClients) throws Throwable
	{
		...
		{
			return rebateCommonUtil.rebate_Webtable_ClickOnCheckBox(AssignmentCriteria_Add_FocusedUMBundleRespiratory_AvailableClient_Table, strAvailableClients);
		}
		else
		{
			return true;
	...
	public boolean updateSelectedFocusedUMBundleRespiratory(String strSelectedFocusedUMBundleRespiratory) throws Throwable
	{
		...
		{
			return rebateCommonUtil.rebate_Webtable_ClickOnCheckBox(AssignmentCriteria_Add_FocusedUMBundleRespiratory_SelectedAssignment_Table, strSelectedFocusedUMBundleRespiratory);
		}
		else
		{
			return true;
	...
	{
		return rxNovaCommonUtil.clickOnButton(AssignmentCriteria_Add_FocusedUMBundleRespiratory_Remove_Button);
	}
	
	public boolean clickOnUpdateButton() throws Throwable
	{
		return rxNovaCommonUtil.clickOnButton(AssignmentCriteria_Add_FocusedUMBundleRespiratory_Update_Button);
	}
	
	public boolean verifySelectedAssignmentDetails(String strSelectedAssignmentDetails) throws Throwable
	{
		return rebateCommonUtil.rebate_Webtable_VerifyRowData(AssignmentCriteria_Add_FocusedUMBundleRespiratory_SelectedAssignment_Table, strSelectedAssignmentDetails);
	}
}
