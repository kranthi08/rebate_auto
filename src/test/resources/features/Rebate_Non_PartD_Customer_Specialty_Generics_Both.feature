@Regression
Feature: Rebate Non-Part D - Assign Tier Description By Customer and Specialty Generics as Tier Description 
  ...
  Scenario Outline: Add the Tier Description Assignment details
    ...
    Examples: 
      ...
      | Add       |                                     | Customer                   | 0888     |           | Tier 9 | Specialty Generics | Customer  |
  ...
  Scenario Outline: Update Tier Description Assignment Details
  	...
  	Then update the following Tier Description Assignment details
  	  | Operation | Tier_Description_Assignment_Details | Assign_Tier_Description_By | Customer | Drug_List | Tier    | Description         |
      | Update    | 888*Tier 9*Specialty Generics       |                            | 888      |           | Tier 10 | Specialty Pref Bnds |
      | Remove    | 888*Tier 10*Specialty Pref Bnds     |                            |          |           |         |                     |
      | Add       |                                     | Customer                   | 0888     |           | Tier 10 | Specialty Pref Bnds |
