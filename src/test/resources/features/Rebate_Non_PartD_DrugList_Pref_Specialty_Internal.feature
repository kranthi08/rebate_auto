@Regression
Feature: Rebate Non-Part D - Assign Tier Description By Drug List and Pref Specialty as Tier Description 
  ...
  Scenario Outline: Add the Tier Description Assignment details
    ...
    Examples: 
      ...
      | Add       |                                     | Drug List                  |          | FLID02046 | Tier 7 | Pref Specialty | Customer  |
  ...
  Scenario Outline: View Tier description assignment details
    ...
    Examples: 
      ...
      | Assignment Criteria | Drug List           |          | FLID02046 | Tier 7 | Pref Specialty |
  ...
  Scenario Outline: Update Tier Description Assignment Details
  	...
  	Then update the following Tier Description Assignment details
  	  | Operation | Tier_Description_Assignment_Details | Assign_Tier_Description_By | Customer | Drug_List | Tier   | Description  |
      | Update    | FLID02046*Tier 7*Pref Specialty     |                            |          | FLID25305 | Tier 8 | NP Specialty |
      | Remove    | FLID25305*Tier 8*NP Specialty       |                            |          |           |        |              |
      | Add       |                                     | Drug List                  |          | FLID25305 | Tier 8 | NP Specialty |
  	Examples: 
  	  | Panel_Name          |
	  	| Assignment Criteria |  		
  ...
  Scenario Outline: View Tier description assignment details
    ...
    Examples: 
      | Panel_Name          | Tier_Description_By | Customer | Drug_List | Tier   | Description  |
      | Assignment Criteria | Drug List           |          | FLID25305 | Tier 8 | NP Specialty |
